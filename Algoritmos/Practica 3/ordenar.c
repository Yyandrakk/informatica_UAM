...
int mergesort (int *tabla, int ip, int iu)
{
	...
	if((dev=mergesort (tabla, ip, medio))==ERR)
		return ERR;
	ob+=dev;
	if((dev=mergesort (tabla, medio+1, iu))==ERR)
		return ERR;
	ob+=dev;
...
int quicksort1 (int *tabla, int ip, int iu)
{
	...
	else
	{
		...
		if( ip<medio-1)
			{if((dev=quicksort1 (tabla, ip, medio-1))==ERR)
				return ERR;
					ob+=dev;
			}
		if( medio+1<iu)
			{if((dev=quicksort1(tabla,medio+1,iu))==ERR)
				return ERR;
				ob+=dev;
			}
	}
...
int quicksort2 (int *tabla, int ip, int iu)
{
	...
	else
	{
		...
		if( ip<medio-1)
			{if((dev=quicksort2 (tabla, ip, medio-1))==ERR)
				return ERR;
					ob+=dev;
			}
		if( medio+1<iu)
			{if((dev=quicksort2(tabla,medio+1,iu))==ERR)
				return ERR;
				ob+=dev;
			}
	}
