  ...
  <body>
    ...
    <?php 
      if (!isset($_REQUEST['id_cliente'])) { 
  		...
  		echo"<h2>Introduce el id que desea borrar</h2> <form action=\"borraCliente.php\" method=\"get\">
        ...
        try {
		  ...
		  if($result===FALSE or $result->fetchColumn()==0){
				...
				if($result===FALSE ){
		   	   ...
		   	   $db->commit();
				echo "Eliminado el cliente, <a href=\"borraCliente.php\">pinche aqui para volver</a> ";
			/*}*/	
