/***************************************************************************
 interface.c
 Funciones necesarias en la practica 4 para extraer la configuracion de interface/socket/enlace
...
* Argumentos: 										*
*  -interface: interface en la que enviar la peticion como una cadena de caracteres	*
...
* Argumentos: 										*
*  -interface: nombre de la interface (ej: eth0)					*
