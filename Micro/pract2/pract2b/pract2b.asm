...
EXTRA SEGMENT
	DIR EQU 4*50h
	;Instalacion de la subrutina que convierte de binario a ASCII en la INT 50h
	CLI ;se pone a 0 el flag de interrupciones
	MOV ES:[DIR], OFFSET imprimir
	MOV ES:[DIR+2], SEG imprimir
...
no_neg:	
	CALL atoi
	CMP BL,7Fh ;COMPROBAMOS QUE NO SE PASE DE TAMAÑO
	JA fallo
compr:
